...
OPTIONS_COMPILE_DEBUG=-D_DEBUG -DDEBUG -DUNIX -DUNIX_MACOS -DBRIDGE_PCAP -DCPU_64 -D_REENTRANT -DREENTRANT -D_THREAD_SAFE -D_THREADSAFE -DTHREAD_SAFE -DTHREADSAFE -D_FILE_OFFSET_BITS=64 -I./src/ -I./src/Cedar/ -I./src/Mayaqua/ -I/opt/homebrew/opt/openssl@3/include -I/opt/homebrew/opt/readline/include -g -fsigned-char

OPTIONS_LINK_DEBUG=-L/opt/homebrew/opt/openssl@3/lib -L/opt/homebrew/opt/readline/lib -g -fsigned-char -lm -lpthread -lssl -lcrypto -liconv -lreadline -lncurses -lz -lpcap

OPTIONS_COMPILE_RELEASE=-DNDEBUG -DVPN_SPEED -DUNIX -DUNIX_MACOS -DBRIDGE_PCAP -DCPU_64 -D_REENTRANT -DREENTRANT -D_THREAD_SAFE -D_THREADSAFE -DTHREAD_SAFE -DTHREADSAFE -D_FILE_OFFSET_BITS=64 -I./src/ -I./src/Cedar/ -I./src/Mayaqua/ -I/opt/homebrew/opt/openssl@3/include -I/opt/homebrew/opt/readline/include -O2 -fsigned-char

OPTIONS_LINK_RELEASE=-L/opt/homebrew/opt/openssl@3/lib -L/opt/homebrew/opt/readline/lib -O2 -fsigned-char -lm -lpthread -lssl -lcrypto -liconv -lreadline -lncurses -lz -lpcap
